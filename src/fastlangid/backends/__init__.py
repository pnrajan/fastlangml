...
from fastlangid.backends.base import Backend, DetectionResult
from fastlangid.exceptions import BackendUnavailableError
...
def _get_backend_class(name: str) -> type[Backend]:
    ...
    if name == "fasttext":
        from fastlangid.backends.fasttext_backend import FastTextBackend
        return FastTextBackend
    elif name == "langdetect":
        from fastlangid.backends.langdetect_backend import LangdetectBackend
        return LangdetectBackend
    elif name == "lingua":
        from fastlangid.backends.lingua_backend import LinguaBackend
        return LinguaBackend
    elif name == "pycld3":
        from fastlangid.backends.pycld3_backend import PyCLD3Backend
