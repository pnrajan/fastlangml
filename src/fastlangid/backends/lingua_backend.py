...
class LinguaBackend(Backend):
    ...
    def supported_languages(self) -> set[str]:
        ...
        return {
            "af", "sq", "ar", "hy", "az", "eu", "be", "bn", "nb", "bs",
            "bg", "ca", "zh", "hr", "cs", "da", "nl", "en", "eo", "et",
            "fi", "fr", "lg", "ka", "de", "el", "gu", "he", "hi", "hu",
            "is", "id", "ga", "it", "ja", "kk", "ko", "la", "lv", "lt",
            "mk", "ms", "mi", "mr", "mn", "nn", "fa", "pl", "pt", "pa",
            "ro", "ru", "sr", "sn", "sk", "sl", "so", "st", "es", "sw",
            "sv", "tl", "ta", "te", "th", "ts", "tn", "tr", "uk", "ur",
            "vi", "cy", "xh", "yo", "zu",
        }
